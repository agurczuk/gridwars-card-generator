...
import { CharacterType, CyberCharacterEnum } from "../Data/Characters";
...
const CharacterEdit = (props: Props) => {
  ...
  console.log(Object.values(CyberCharacterEnum));
  console.log(Object.keys(CyberCharacterEnum));
  ...
  return (
    <Column>
      ...
      />
      <DropDown values={values} onChange={() => {}} label="name" />
      <Textbox
        label="ability name"
      ...
      <Columns>
        <Column>
          <div>
            ...
            <Textbox value={gun} onChange={(v) => setGun(v as string | null)} />
            {/* <Icon
              path={
